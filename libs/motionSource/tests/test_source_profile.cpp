...
using openstrata::motion::FindRestPoseSource;
using openstrata::motion::FindRootRotationPolicy;
using openstrata::motion::FindRootTranslationPolicy;
using openstrata::motion::FindSourceAxis;
using openstrata::motion::FindSourceHandedness;
using openstrata::motion::FindSourceLengthUnit;
using openstrata::motion::FindUnmappedJointPolicy;
using openstrata::motion::MatchSourceProfile;
using openstrata::motion::RestPoseSource;
using openstrata::motion::RestPoseSourceCount;
using openstrata::motion::RestPoseSourceName;
using openstrata::motion::RootRotationPolicy;
using openstrata::motion::RootRotationPolicyCount;
using openstrata::motion::RootRotationPolicyName;
using openstrata::motion::RootTranslationPolicy;
using openstrata::motion::RootTranslationPolicyCount;
using openstrata::motion::RootTranslationPolicyName;
using openstrata::motion::SourceAxis;
using openstrata::motion::SourceAxisComponent;
using openstrata::motion::SourceAxisCount;
using openstrata::motion::SourceAxisIsNegative;
using openstrata::motion::SourceAxisName;
using openstrata::motion::SourceHandedness;
using openstrata::motion::SourceHandednessCount;
using openstrata::motion::SourceHandednessName;
using openstrata::motion::SourceJoint;
using openstrata::motion::SourceJointMapping;
using openstrata::motion::SourceLengthUnit;
using openstrata::motion::SourceLengthUnitCount;
using openstrata::motion::SourceLengthUnitInMeters;
using openstrata::motion::SourceLengthUnitName;
using openstrata::motion::SourceProfile;
using openstrata::motion::SourceProfileMatch;
using openstrata::motion::SourceProfileRefusal;
using openstrata::motion::SourceProfileRefusalCount;
using openstrata::motion::SourceProfileRefusalName;
using openstrata::motion::SourceSkeleton;
using openstrata::motion::SourceVec3;
using openstrata::motion::UnmappedJointPolicy;
using openstrata::motion::UnmappedJointPolicyCount;
using openstrata::motion::UnmappedJointPolicyName;
